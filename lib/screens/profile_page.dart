                        ...
                        onPressed: () {
                          if(_allowEdit==true){
                            showDialog(context: context,
                                builder: (context){
                                  return AlertDialog(
                                    title: TextResponsive("Thông báo",style: TextStyle(fontSize: ScreenUtil().setSp(100)),),
                                    content: TextResponsive("Bạn sẽ thoát và không lưu?",style: TextStyle(fontSize: ScreenUtil().setSp(70))),
                                    actions: <Widget>[
                                      MaterialButton(
                                        onPressed: (){
                                          Navigator.pushNamed(context, '/main');
                                        },
                                        child: TextResponsive("Thoát",
                                          style: TextStyle(fontSize: ScreenUtil().setSp(70), color: Colors.blue,fontWeight: FontWeight.normal),
                                        ),
                                      ),
                                      MaterialButton(
                                        onPressed: (){
                      ...
                      Card(
                          child: ListTile(
                            ...
                            title: TextResponsive(
                              "Tài khoản",
                              style: TextStyle(
                                  fontSize: ScreenUtil().setSp(70), color: Colors.blueAccent),
                            ),
